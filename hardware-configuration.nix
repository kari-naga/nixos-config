...

{
  ...
  fileSystems."/" =
    { device = "/dev/disk/by-uuid/fde695e7-bfef-4c8f-8ebc-7cffd4da50c4";
      fsType = "btrfs";
      options = [ "subvol=@" ];
    };

  fileSystems."/boot" =
    { device = "/dev/disk/by-uuid/293E-0E22";
      fsType = "vfat";
    };

  swapDevices =
    [ { device = "/dev/disk/by-uuid/c62efab4-6d47-471a-b39b-e4f239717280"; }
    ];
